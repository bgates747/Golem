; ============================================================================
; VENDORED REFERENCE EXAMPLE - NOT YET IMPLEMENTED OR ADAPTED FOR GOLEM.
;
; This is a read-only copy of `flower.asm` from
; /home/smith/Agon/mystuff/agon-utils/examples/flower/src/flower.asm,
; kept here purely as a worked example of a real MOSlet's command-line
; argument parsing (see this directory's README.md). It is NOT built,
; included, or referenced by any Golem toolchain code, and NOT a Golem
; program. Do not edit in place - if Golem ever implements its own
; MOSlet-based loader (see docs/design/language-type-proposals.md, "Axis
; 17"), port and adapt the relevant logic there instead.
; ============================================================================
;
; Title:	flower
